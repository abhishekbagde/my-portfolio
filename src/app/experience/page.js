  ...
  const experiences = [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Architected and developed key banking modules, including a transaction processing system and a fraud detection algorithm, utilizing Python, Django, C#, Node.js, and Express.js, alongside Azure services. The integration of modern web technologies, including React.js for customer-facing interfaces, resulted in a 30% increase in transaction speed and a 25% reduction in fraudulent activities.",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Developed and maintained multiple web applications including a Car Rental System, Global Rewards and Incentives Platform, and Travel and Events Management Application. Utilized React.js, Node.js, .NET, Azure, C#, JavaScript, HTML/CSS, SQL, and Agile methodologies. Designed and implemented RESTful APIs for seamless data exchange and integration between front-end (React) and back-end services (Node.js).",
